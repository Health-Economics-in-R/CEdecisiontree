...
[![Build Status](https://travis-ci.org/Health-Economics-in-R/QALY.svg?branch=master)](https://travis-ci.org/Health-Economics-in-R/CEdecisiontree)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/Health-Economics-in-R/QALY?branch=master&svg=true)](https://ci.appveyor.com/project/Health-Economics-in-R/CEdecisiontree)
